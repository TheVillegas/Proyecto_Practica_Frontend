...
CREATE TABLE TPA_REPORTE (
    ...
    CONSTRAINT FK_tpa_muestra FOREIGN KEY (codigo_ali) REFERENCES MUESTRAS_ALI(codigo_ali),
...
CREATE TABLE TPA_ETAPA2_SESION (
    ...
    CONSTRAINT FK_e2_reporte FOREIGN KEY (codigo_ali) REFERENCES TPA_REPORTE(codigo_ali),
...
CREATE TABLE TPA_ETAPA3_CHECKLIST (
    ...
    CONSTRAINT FK_e3_rep FOREIGN KEY (codigo_ali) REFERENCES TPA_REPORTE(codigo_ali)
);
...
CREATE TABLE TPA_ETAPA4_RETIRO (
    ...
    CONSTRAINT FK_e4_rep FOREIGN KEY (codigo_ali) REFERENCES TPA_REPORTE(codigo_ali),
...
CREATE TABLE TPA_ETAPA5_SIEMBRA (
    ...
    CONSTRAINT FK_e5_rep FOREIGN KEY (codigo_ali) REFERENCES TPA_REPORTE(codigo_ali)
);
...
CREATE TABLE RAM_REPORTE (
    ...
    CONSTRAINT FK_ram_central FOREIGN KEY (codigo_ali) REFERENCES MUESTRAS_ALI(codigo_ali)
);
